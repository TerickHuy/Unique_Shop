...
public class SanPhamAdapter extends RecyclerView.Adapter<SanPhamAdapter.ViewHolder> {
    ...
    private ArrayList<SanPhamDomain> list;
    ArrayList<SanPhamDomain> listSort;
    Filter filter;
    ...
    public SanPhamAdapter(Context context, ArrayList<SanPhamDomain> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        SanPhamDomain sp = list.get(position);
        //Set tiêu đề
    ...
    private class CustomFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0) {
                ...
                ArrayList<SanPhamDomain> findItem = new ArrayList<>();
                for (SanPhamDomain p : list) {
...
//                notifyDataSetInvalidated();
                ...
                list = (ArrayList<SanPhamDomain>) results.values;
