...
//    }
    ...
    public ArrayList getAll() {
        ArrayList<SanPhamDomain> list = new ArrayList<>();
        list.add(new SanPhamDomain(1, "Áo ba lỗ nam THE 1992 Áo tanktop sát nách nam RUNNING", "Thông tin sản phẩm Áo ba lỗ nam sát nách THE 1992:\n"+
        ...
        list.add(new SanPhamDomain(2, "Áo Thun Cổ Tròn Y Nguyên Bản 18+ Summer M11","Chất liệu: Cá Sấu Poly\n"+
                "Thành phần: 100% poly\n"+
                "- Họa tiết in chuyển nhiệt + in dẻo","148000","ao", R.drawable.anh2));
        list.add(new SanPhamDomain(3, "Áo Thun Cổ Trụ Đơn Giản J01","Chất liệu: Cotton 4 Chiều\n"+
                "Thành phần: 95% cotton 5% Spandex\n"+
                "- Co giãn tốt\n"+
                "- Độ bền cao","150000","ao", R.drawable.anh3));
        list.add(new SanPhamDomain(4, "Áo Thun Cổ Tròn Đơn Giản M2","Chất liệu: Cotton 2 chiều\n"+
                "Thành phần: 100% Cotton\n"+
                "- Co dãn 2 chiều\n"+
                "- Thấm hút mồ hôi tốt mang lại cảm giác thoáng mát","150000","ao", R.drawable.anh4));
        list.add(new SanPhamDomain(5, "Áo Thun Cổ Tròn Y Nguyên Bản 18+ Summer M12","Chất liệu: Cotton Compact\n"+
                "Thành phần: 100% Cotton\n"+
                "- Thân thiện\n"+
                "- Thấm hút thoát ẩm\n"+
                "- Mềm mại\n"+
        ...
        list.add(new SanPhamDomain(6, "Áo Thun Cổ Tròn Đơn Giản M20","Chất liệu: Cotton 2 chiều\n"+
                "Thành phần: 100% Cotton\n"+
                "- Thân thiện\n"+
                "- Thấm hút thoát ẩm\n"+
                "- Mềm mại\n"+
        ...
        list.add(new SanPhamDomain(9, "Sơ Mi Tay Dài Đơn Giản N01","Chất liệu: Vải cafe (Công nghệ sợi làm từ bã cafe)\n"+
        ...
        list.add(new SanPhamDomain(10, "Sơ Mi Tay Dài Đơn Giản M16 ","Chất liệu: Vải Sơ Mi\n"+
        ...
        list.add(new SanPhamDomain(11, "Quần Dài Tây Đơn Giản HG10","Chất liệu: Vải Quần Tây\n"+
        ...
        list.add(new SanPhamDomain(12, "Quần Dài Jogger Đơn Giản M6","Chất liệu: Vải Kaki Thun\n"+
        ...
        list.add(new SanPhamDomain(13, "Quần Dài Jogger Đơn Giản M4","- Chất liệu:\n"+
                "MINI ZURRY\n"+
                "- Thành Phần:\n"+
                "+ 94% COTTON\n"+
                "- Thân thiện\n"+
        ...
        list.add(new SanPhamDomain(14, "Quần Dài Jean Slimfit Đơn Giản B19","Chất liệu: Jean Cotton\n"+
                "Thành phần: 98% cotton 2% spandex\n"+
                "- Độ bền cao\n"+
                "- Mặc mát, rất thoải mái.","425000","quan", R.drawable.anh14));
        list.add(new SanPhamDomain(15, "Quần Dài Jean Slimfit Đơn Giản B42","Chất liệu: Jean Cotton\n"+
        ...
        list.add(new SanPhamDomain(16, "Quần Dài Tây Đơn Giản B2X03 ","Quần Dài Form Tiêu Chuẩn / Mã số: 0017426","425000","quan", R.drawable.anh16));
        list.add(new SanPhamDomain(17, "Quần Dài Tây Đơn Giản B2HG06","Quần Dài Form Tiêu Chuẩn / Mã số: 0019082","425000","quan", R.drawable.anh17));
        list.add(new SanPhamDomain(18, "Quần Dài Jean Slimfit Đơn Giản B16 ","Chất liệu: Jean\n"+
        ...
        list.add(new SanPhamDomain(19, "Quần Dài Jean Slimfit Đơn Giản B31","Chất liệu: Jean Cotton\n"+
                "Thành phần: 99,4% cotton 0,6% spandex","425000","quan", R.drawable.anh19));
        list.add(new SanPhamDomain(20, "Quần Dài Jean Slimfit Đơn Giản B16 ","Chất liệu: Jean\n"+
                "Thành phần: Cotton Duck\n"+
                "- Độ bền rất cao.\n"+
                "- Mặc rất thoải mái.\n"+
                "HDSD:\n"+
        ...
        list.add(new SanPhamDomain(21, "Giày Casual Đơn Giản M3 ","Chất liệu: Microfiber\n"+
                "- Đế: Cao Su\n"+
                "- Độ bền rất cao.\n"+
                "- Ngoại hình tinh tế.\n"+
                "HDSD:\n"+
        ...
        list.add(new SanPhamDomain(22, "Giày Casual Đơn Giản M6 ","Chất liệu: Microfiber\n"+
                "- Đế: Cao Su\n"+
                "- Lót Vòng cổ Pu\n"+
                "- Lót Mousse 3mm + Mesh\n"+
        ...
        list.add(new SanPhamDomain(23, "Sandal Đế Thấp Đơn Giản M3 ","Chất liệu: Vải mesh + PU foam 3mm\n"+
                "- Đế: Phylon siêu nhẹ\n"+
                "- Dây đai nylon\n"+
                "- Viền thun\n"+
                "- Lót mesh\n"+
        ...
        list.add(new SanPhamDomain(24, "Vớ Đơn Giản V01 ","Chất liệu: 90% Cotton 10% Spandex\n"+
        ...
        list.add(new SanPhamDomain(25, "Vớ Đơn Giản V12 ","Chất liệu: 90% Cotton 10% Spandex\n"+
                "- Mềm mại, bó sát cổ chân\n"+
                "- Thoáng khí\n"+
                "- Co giãn, đàn hồi cao\n"+
                "- Khử mùi\n"+
        ...
        list.add(new SanPhamDomain(26, "Nón Thiên Nhiên Kì Vĩ Darkness Hunters Ver1 ","Chất liệu: Kaki\n"+
                "Thành phần: 100% cotton\n"+
        ...
        list.add(new SanPhamDomain(27, "Balo laptop STARGO HEBEN ","Chất liệu: Polyester\n"+
                "- Chống thấm\n"+
                "- Hút ẩm\n"+
                "- Cổng sạc USB\n"+
                "HDSD:\n"+
        ...
        list.add(new SanPhamDomain(28, "Balo teen DONNA ","Chất liệu: Polyester\n"+
                "- Chống thấm\n"+
                "- Hút ẩm\n"+
                "- Chống bám bụi\n"+
                "HDSD:\n"+
        ...
        list.add(new SanPhamDomain(29, "Ví Đơn Giản C16 ","Chất liệu: Da bò Saffiano nhập khẩu\n"+
        ...
        list.add(new SanPhamDomain(30, "Dây Nịt Đơn Giản M12 ","Chất liệu: Da Bò Thật 100%\n"+
                "- Thiết kế lịch lãm\n"+
                "HDSD:\n"+
